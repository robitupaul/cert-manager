...
type ACMEChallengeSolverHTTP01 struct {
	...
	//The Contour HTTPProxy based HTTP01 challenge solver will solve
	//challenges by creating a HTTPProxy resource in order to route
	//requests for '/.well-known/acme-challenge/XYZ' to 'challenge solver'
