...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*v1.ACMEChallengeSolverHTTP01HTTPProxy)(nil), (*acme.ACMEChallengeSolverHTTP01HTTPProxy)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_ACMEChallengeSolverHTTP01HTTPProxy_To_acme_ACMEChallengeSolverHTTP01HTTPProxy(a.(*v1.ACMEChallengeSolverHTTP01HTTPProxy), b.(*acme.ACMEChallengeSolverHTTP01HTTPProxy), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*acme.ACMEChallengeSolverHTTP01HTTPProxy)(nil), (*v1.ACMEChallengeSolverHTTP01HTTPProxy)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_acme_ACMEChallengeSolverHTTP01HTTPProxy_To_v1_ACMEChallengeSolverHTTP01HTTPProxy(a.(*acme.ACMEChallengeSolverHTTP01HTTPProxy), b.(*v1.ACMEChallengeSolverHTTP01HTTPProxy), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1_ACMEChallengeSolverHTTP01_To_acme_ACMEChallengeSolverHTTP01(in *v1.ACMEChallengeSolverHTTP01, out *acme.ACMEChallengeSolverHTTP01, s conversion.Scope) error {
	...
	out.HTTPProxy = (*acme.ACMEChallengeSolverHTTP01HTTPProxy)(unsafe.Pointer(in.HTTPProxy))
...
func autoConvert_acme_ACMEChallengeSolverHTTP01_To_v1_ACMEChallengeSolverHTTP01(in *acme.ACMEChallengeSolverHTTP01, out *v1.ACMEChallengeSolverHTTP01, s conversion.Scope) error {
	...
	out.HTTPProxy = (*v1.ACMEChallengeSolverHTTP01HTTPProxy)(unsafe.Pointer(in.HTTPProxy))
...
func autoConvert_v1_ACMEChallengeSolverHTTP01HTTPProxy_To_acme_ACMEChallengeSolverHTTP01HTTPProxy(in *v1.ACMEChallengeSolverHTTP01HTTPProxy, out *acme.ACMEChallengeSolverHTTP01HTTPProxy, s conversion.Scope) error {
	out.ServiceType = corev1.ServiceType(in.ServiceType)
	out.Labels = *(*map[string]string)(unsafe.Pointer(&in.Labels))
...
// Convert_v1_ACMEChallengeSolverHTTP01HTTPProxy_To_acme_ACMEChallengeSolverHTTP01HTTPProxy is an autogenerated conversion function.
func Convert_v1_ACMEChallengeSolverHTTP01HTTPProxy_To_acme_ACMEChallengeSolverHTTP01HTTPProxy(in *v1.ACMEChallengeSolverHTTP01HTTPProxy, out *acme.ACMEChallengeSolverHTTP01HTTPProxy, s conversion.Scope) error {
	return autoConvert_v1_ACMEChallengeSolverHTTP01HTTPProxy_To_acme_ACMEChallengeSolverHTTP01HTTPProxy(in, out, s)
}

func autoConvert_acme_ACMEChallengeSolverHTTP01HTTPProxy_To_v1_ACMEChallengeSolverHTTP01HTTPProxy(in *acme.ACMEChallengeSolverHTTP01HTTPProxy, out *v1.ACMEChallengeSolverHTTP01HTTPProxy, s conversion.Scope) error {
	out.ServiceType = corev1.ServiceType(in.ServiceType)
	out.Labels = *(*map[string]string)(unsafe.Pointer(&in.Labels))
...
// Convert_acme_ACMEChallengeSolverHTTP01HTTPProxy_To_v1_ACMEChallengeSolverHTTP01HTTPProxy is an autogenerated conversion function.
func Convert_acme_ACMEChallengeSolverHTTP01HTTPProxy_To_v1_ACMEChallengeSolverHTTP01HTTPProxy(in *acme.ACMEChallengeSolverHTTP01HTTPProxy, out *v1.ACMEChallengeSolverHTTP01HTTPProxy, s conversion.Scope) error {
	return autoConvert_acme_ACMEChallengeSolverHTTP01HTTPProxy_To_v1_ACMEChallengeSolverHTTP01HTTPProxy(in, out, s)
}
